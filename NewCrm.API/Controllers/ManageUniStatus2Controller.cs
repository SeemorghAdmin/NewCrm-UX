...
namespace NewCrm.API.Controllers
{
    ...
    [ApiController]
    public class ManageUniStatus2Controller : ControllerBase
    {
        private nernContext _contextt;
        public ManageUniStatus2Controller(nernContext nernContext)
        {
